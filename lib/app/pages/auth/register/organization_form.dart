      ...
      case 2:
        ...
        bool validAdditionalInfo =
            (_formKeyAdditionalInfo.currentState?.validate() ?? false) &&
                ...
                controller.organizationOpeningTime.isNotEmpty &&
                controller.organizationClosingTime.isNotEmpty &&
                isOpeningAndClosingEqual;
        // bool validAdditionalInfo =
        //     _formKeyAdditionalInfo.currentState?.validate() ?? false;
          ...
          controlsBuilder: (BuildContext context, ControlsDetails details) {
            return Column(
              children: [
                ...
                //     child: SizedBox(width: 140, child: Divider())),
                Row(
                  children: <Widget>[
                    _currentStep == 3
                        ? Center(
